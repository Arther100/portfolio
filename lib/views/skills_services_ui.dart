                            ...
                            Flexible(flex: 1,child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextWidget.body("State Management(GetX, Provider, Bloc), API Integration, RESTful Services", context, color: MyColors.textMenu,textAlign: TextAlign.center,),
                                  // Align(alignment: Alignment.centerLeft, child: TextWidget.semiHeader3gold("Languages:", context, color: MyColors.textMenu,)),
                                  TextWidget.semiHeader3("Dart • Java • C • C++ • C# • Python • HTML", context, color: MyColors.textMenu,),
                                  // Align(alignment: Alignment.centerLeft, child: TextWidget.semiHeader3gold("Databases:", context, color: MyColors.textMenu,)),
                                  TextWidget.semiHeader3("MySQL • SQLite • Firebase • MongoDB • JDBC", context, color: MyColors.textMenu,),
                                  ...
                                  TextWidget.semiHeader3("Agile (Scrum)", context, color: MyColors.textMenu,),
                                  // Align(alignment: Alignment.centerLeft, child: TextWidget.semiHeader3gold("Publishing:", context, color: MyColors.textMenu,)),
                                  TextWidget.semiHeader3("Play Store • App Store • Hosting on Private Servers • GitHub Pages", context, color: MyColors.textMenu,),
                                  // Align(alignment: Alignment.centerLeft, child: TextWidget.semiHeader3gold("Design:", context, color: MyColors.textMenu,)),
                                  TextWidget.semiHeader3("Git • GitHub • Visual Studio Code • Android Studio • Eclipse", context, color: MyColors.textMenu,),
                                  TextWidget.semiHeader3("Figma (UI/UX Design)", context, color: MyColors.textMenu,),
                                  TextWidget.semiHeader3("Data Structure & Algorithms • Problem Solving Techniques", context, color: MyColors.textMenu,),
                                ],
                              ),
                            ),
                            ),
