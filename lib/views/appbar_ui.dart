      ...
      child: Row(
        children: [
          Center(
            child: InkWell(
              onTap: () {
                ScrollToPage.changePage(Pages.heroSection.index);
              },
              child: Row(
                children: [
                  SizedBox(
                    width: Responsive.isVertical(context) ? 15 : 30,
                  ),
                  const Icon(
            ...
            children: isVertical || Responsive.isMobile(context)
                ? [
                    Center(
                      child: ButtonWidget(
                        onPressed: () {
                          ScrollToPage.changePage(Pages.contact.index);
                          setState(() {});
                        },
                ...
                : [
                    TextButtonWidget(
                        onPressed: () {
                          ScrollToPage.changePage(Pages.about.index);
                        },
                        height: 45,
                        width: 140,
                        label: TextWidget.body(
                    ...
                    TextButtonWidget(
                        onPressed: () {
                          ScrollToPage.changePage(Pages.skills.index);
                        },
                        height: 45,
                        width: 145,
                        label: TextWidget.body(
                    ...
                    TextButtonWidget(
                        onPressed: () {
                          ScrollToPage.changePage(Pages.projects.index);
                        },
                        height: 45,
                        width: 140,
                        label: TextWidget.body(
