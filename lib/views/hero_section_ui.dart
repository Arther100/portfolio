            ...
            children: [
              Row(
                children: [
                  ...
                  Responsive.getWidth(context) < 720
                      ? Container()
                      : Expanded(
                          child: introText(),
                        ),
...
//typing style for role----------
  ...
  void startTyping() async {
    while (true) {
      ...
      for (charIndex = 0;
          charIndex <= texts[currentTextIndex].length;
          charIndex++) {
        setState(() {
          displayedText = texts[currentTextIndex].substring(0, charIndex);
        });
        await Future.delayed(
            Duration(milliseconds: 50)); // Delay for typing effect
      }
      ...
      for (charIndex = texts[currentTextIndex].length;
          charIndex >= 0;
          charIndex--) {
        setState(() {
          displayedText = texts[currentTextIndex].substring(0, charIndex);
        ...
        await Future.delayed(
            Duration(milliseconds: 25)); // Delay for deleting effect
      }
    ...
    while (true) {
      ...
      setState(() {
        _currentIndex = (_currentIndex + 1) %
            texts.length; // Loop back to the first text after the last one
      });
    }
  }
    ...
    return Column(
      ...
      children: [
        ...
        RichText(
          ...
          TextSpan(
              ...
              style: TextStyle(
                ...
                fontSize: FontSizes.header2(context),
          ...
          TextSpan(
              ...
              style: TextStyle(
                fontFamily: Constants.font,
                fontSize: FontSizes.header1(context),
                fontWeight: FontWeights.semiBoldHeader,
                color: MyColors.black,
              )),
        ])),
        Row(
        ...
        RichText(
            text: TextSpan(children: [
          TextSpan(
              text: 'I am a professional software developer specializing in ',
              style: TextStyle(
          ...
          TextSpan(
              text:
                  'crafting innovative software, websites, and mobile apps for Android and iOS. ',
              style: TextStyle(
                fontSize: FontSizes.body(context),
          ...
          TextSpan(
              text:
                  'My work stands out with its user-friendly interfaces, high performance, and visually appealing responsive designs. ',
              style: TextStyle(
                fontSize: FontSizes.body(context),
                fontWeight: FontWeights.regular,
                color: MyColors.black,
          ...
          TextSpan(
              text:
                  'I transform your vision into seamless software solutions that work flawlessly across platforms and devices',
              style: TextStyle(
                fontSize: FontSizes.body(context),
                fontWeight: FontWeights.semiBold,
                color: MyColors.black,
          ...
          TextSpan(
              text:
                  ', including web, Android, iOS, macOS, Windows, mobile, and desktop.',
              style: TextStyle(
                fontSize: FontSizes.body(context),
                fontWeight: FontWeights.regular,
                color: MyColors.black,
            ...
            Row(
              children: [
                ...
                ContactIconWidget(
                    ...
                    onPressed: () async {
                      await FunctionalServices.launchAndCopyUrl(
                          context: context, URL: Constants.linkLinkedIn);
                    }),
                ContactIconWidget(
                    label: '',
                    ...
                    onPressed: () async {
                      await FunctionalServices.launchAndCopyUrl(
                          context: context, URL: Constants.linkGit);
                    }),
              ],
            ),
            Spacer(),
            !Responsive.isMobile(context)
                ? ContactUi.resumeBtn(context)
                : Container(),
          ],
        ),
        Responsive.isMobile(context)
        ...
        Responsive.isMobile(context)
            ? Align(
                ...
                child: ContactUi.resumeBtn(context))
            : Container(),
      ],
    );
  }
  ...
  Widget profileImage() {
    return Stack(
      children: [
        Padding(
          padding: EdgeInsets.only(
            left: Responsive.isVertical(context) ? 2 : 4,
            bottom: Responsive.isVertical(context) ? 2 : 4,
          ),
          child: ClipRRect(
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    width: Responsive.isVertical(context) ? 2 : 4,
                ...
                child: ScrollConfiguration(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        padding: EdgeInsets.only(
                          top: widget.scrollDir == Axis.horizontal ? 0 : 50,
                          left: widget.scrollDir == Axis.horizontal ? 50 : 0,
                        ),
                        child: SizedBox(
                          width: size.width /
                              (widget.scrollDir == Axis.horizontal ? 8 : 2),
                          height: size.height /
                              (widget.scrollDir == Axis.horizontal ? 2 : 8),
                          // width: 130,
                          // height: 130,
                          child: Image.network(
                            widget.images[index],
